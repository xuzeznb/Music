...
<el-col :span="8" style="display:flex ; justify-content: right;margin-top: 20px;">
    <el-space direction="vertical" alignment="flex-start">
        <el-skeleton style="width: 200px" :loading="loading" animated :throttle="500">
            <template #template>
...
<div  style="margin-top: 20px;padding-left: 10px">
  ...
  <div style="margin-top: 20px;display: flex;justify-content: center">
    ...
    <el-tab-pane label="专辑" name="first">
          <div style="">
            <h3>热门50首 <el-icon style="margin-left: 20px;"><VideoPlay /></el-icon>
              <el-icon style="margin-left: 10px"><Star /></el-icon>  </h3>
              <el-table
                  ref="singleTableRef"
                  :data="state.Create"
              ...
              >
                ...
                <a href="javascript:;"  ><icon-like/></a>
                <a href="javascript:;" @click="download" style="padding-left: 8px"><icon-download/></a>
                </el-table-column>
                <a href="javascript:;" @click="like"></a>
                <el-table-column property="name" label="歌名" :show-overflow-tooltip="true" width="150" />
                <el-table-column property="address"  />
              </el-table>
            <div style="color: #a1a1a0;font-size: 13px;width: 500px;text-align: center">
             <a style="cursor:pointer" @click="whole" v-if="state.wholesong">查看全部50首 </a>
            </div>
          </div>
    </el-tab-pane>
